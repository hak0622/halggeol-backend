...
INSERT INTO deposit (id, name, rate, prime_rate, join_way, end_date, max_limit, join_member, join_deny, bonus_condition, save_term, minimum_cost, company, score, risk, reg_link, caution, view_cnt, scrap_cnt, regret_cnt, algo_code) VALUES
                                                                                                                                                                                                                                           ('D1', 'WON플러스예금', 2.50, 3.50, '인터넷,스마트폰,전화(텔레뱅킹)', NULL, NULL, '실명의 개인', 1, '해당사항 없음', 12, '1만원 이상', '우리은행', 85, 3, 'https://wooribank.com', '- 가입기간: 1~36개월
- 최소가입금액: 1만원 이상
- 만기일을 일,월 단위로 자유롭게 선택 가능
- 만기해지 시 신규일 당시 영업점과 인터넷 홈페이지에 고시된 계약기간별 금리 적용', 1200, 350, 50, 0.85),
                                                                                                                                                                                                                                           ('D2', 'e-그린세이브예금', 2.80, 3.80, '인터넷,스마트폰', '9999-12-31', 1000000000, '개인(개인사업자 포함)', 1, '1.SC제일은행 최초 거래 신규고객에 대하여 우대 이율을 제공함 (보너스이율0.2%)                     2.SC제일마이백통장에서 출금하여 이 예금을 신규하는경우에 보너스이율을 제공함
(가입기간:1년제/ 보너스이율:0.1% / 만기해약하는 경우에 한해 보너스이율을 적용함)', 24, '1백만원 이상', '한국스탠다드차타드은행', 90, 2, 'https://standardchartered.co.kr', '디지털채널 전용상품 (인터넷, 모바일뱅킹)', 1500, 400, 60, 0.90),
                                                                                                                                                                                                                                           ('D3', 'iM주거래우대예금(첫만남고객형)', 2.60, 3.60, '영업점,인터넷,스마트폰', NULL, NULL, '실명의 개인', 1, '* 최고우대금리 : 연0.65%p
 ...
 * 해당 상품을 인터넷/모바일뱅킹을 통해 가입 : 연0.05%p', 12, '100만원', '아이엠뱅크', 88, 3, 'https://imbank.com', '계좌당 가입 최저한도 : 100만원', 1100, 300, 45, 0.88),
                                                                                                                                                                                                                                           ('D4', 'iM행복파트너예금(일반형)', 2.40, 3.40, '영업점,인터넷,스마트폰', NULL, NULL, '만50세 이상 실명의 개인', 3, '* 최고우대금리 : 연0.45%p
...
* 해당 상품을 인터넷/모바일뱅킹을 통해 가입 : 연0.05%p', 12, '100만원', '아이엠뱅크', 82, 4, 'https://imbank.com', '계좌당 가입 최저한도 : 100만원', 950, 280, 40, 0.82),
                                                                                                                                                                                                                                           ('D5', 'iM함께예금', 2.30, 3.30, '영업점,인터넷,스마트폰', NULL, NULL, '실명의 개인 및 개인사업자', 1, '* 최고우대금리 : 연0.45%p
...
* 해당 상품을 인터넷/모바일뱅킹을 통해 가입 시 : 연0.05%p', 12, '100만원', '아이엠뱅크', 80, 3, 'https://imbank.com', '계좌당 가입 최저한도 : 100만원', 900, 270, 38, 0.80),
                                                                                                                                                                                                                                           ('D6', 'iM스마트예금', 2.20, 3.20, '인터넷,스마트폰', NULL, NULL, '실명의 개인', 1, '* 최고우대금리 : 연0.25%p
...
* 해당 상품을 인터넷/모바일뱅킹을 통해 가입 : 연0.05%p', 12, '100만원', '아이엠뱅크', 78, 2, 'https://imbank.com', '계좌당 가입 최저한도 : 100만원', 850, 250, 35, 0.78),
                                                                                                                                                                                                                                           ('D7', 'LIVE정기예금', 2.70, 3.70, '영업점,인터넷', NULL, NULL, '제한없음', 1, '*우대이율
가. 3~5개월 특판우대이율 : 0.70%
...
3. 월이자지급식/만기일시지급식', 1300, 380, 55, 0.87),
                                                                                                                                                                                                                                           ('D8', '더(The) 특판 정기예금', 2.90, 3.90, '인터넷,스마트폰', NULL, NULL, '실명의 개인', 1, '* 우대이율 (최대 0.70%p)
...
3. 이자지급방식 : 만기일시지급식', 1600, 450, 70, 0.92),
                                                                                                                                                                                                                                           ('D9', '더(The) 레벨업 정기예금', 2.55, 3.55, '스마트폰', NULL, NULL, '실명의 개인', 1, '*우대이율(최대 0.20%p)
가. 모바일뱅킹 금융정보 및 혜택알림 동의 우대이율 : 0.10%p
...
3. 이자지급방식 : 만기일시지급식', 1150, 330, 48, 0.86),
                                                                                                                                                                                                                                           ('D10', '미즈월복리정기예금', 2.45, 3.45, '영업점,인터넷,스마트폰,기타', NULL, 50000000, '만18세이상 여성으로 실명의 개인 및 개인사업자', 1, '▶ 최고우대금리 0.2%
...
2. 가입금액 : 5백만원이상 최고 50백만원', 1000, 300, 42, 0.84),
                                                                                                                                                                                                                                           ('D11', '스마트모아Dream정기예금', 2.35, 3.35, '인터넷,스마트폰', NULL, NULL, '개인 및 개인사업자', 1, '▶ 1천만원 이상 가입시 최대 0.2%우대', 12, '100만원이상', '광주은행', 81, 2, 'https://kjbank.com', '1. 가입기간 : 1개월이상 3년제
2. 최소가입금액 : 100만원이상', 980, 290, 40, 0.81),
                                                                                                                                                                                                                                           ('D12', '굿스타트예금', 3.00, 4.00, '스마트폰', NULL, 100000000, '개인 및 개인사업자', 1, '▶ 최고우대금리 0.5%
...
2. 가입금액 : 1백만원이상 최고 1억원(1인1계좌)', 1800, 500, 80, 0.95),
                                                                                                                                                                                                                                           ('D13', 'The플러스예금', 2.65, 3.65, '영업점,스마트폰', NULL, 1000000000, '개인 및 법인(단,국가 지자체 및 금융기관 제외)', 1, '▶ 해당사항없음', 6, '10백만원이상', '광주은행', 89, 3, 'https://kjbank.com', '1. 가입기간 : 3개월,6개월,1년제
...
(단, 이벤트시 영업점,디지털채널에 고시한 우대금리를 추가 적용할 수 있음)', 12, '1백만원 이상', '제주은행', 77, 3, 'https://jejuebank.co.kr', '가입금액 : 1백만원 이상', 750, 220, 30, 0.77),
                                                                                                                                                                                                                                           ('D17', 'JB 다이렉트예금통장
(만기일시지급식)', 2.85, 3.85, '인터넷,스마트폰', NULL, 1000000000, '실명의 개인(임의단체 제외', 1, '우대조건
없음', 12, '1백만원이상', '전북은행', 93, 2, 'https://jbbank.co.kr', '가입금액 1계좌당 1백만원이상 10억원이하,
1인당  총 10억원 이하,
인터넷/스마트폰뱅킹 가입상품', 1700, 480, 75, 0.93),
                                                                                                                                                                                                                                           ('D18', 'JB 123 정기예금
 (만기일시지급식)', 2.95, 3.95, '인터넷,스마트폰', NULL, 500000000, '실명의 개인 또는 개인사업자 (1인 다계좌 가입 가능함)', 1, '자동재예치 우대이율
1회차 0.1%,
2회차 0.2%,
...
가입금액 최저 1백만원이상 고객별 5억원 이상 (다만 자동재예치시 이자 원가로 인한 5억원 초과는 가능), 계좌수 관계없이 가입가능', 1900, 520, 85, 0.94),
                                                                                                                                                                                                                                           ('D19', '내맘 쏙 정기예금', 2.70, 3.70, '인터넷,스마트폰', NULL, 999999999999, '실명의 개인 및 개인사업자', 1, '1. 모바일뱅킹 첫거래 고객 0.10%
2. 마케팅동의고객 0.10%
...
계약기간 : 1개월이상 12개월이내(월단위)', 1550, 430, 68, 0.90),
                                                                                                                                                                                                                                           ('D20', 'BNK더조은정기예금', 2.60, 3.60, '인터넷,스마트폰', '9999-12-31', 500000000, '거래대상자는 제한을 두지 아니한다. 다만, 국가 및 지방자치단체는 이 예금을 거래할 수 없다.', 1, '①가입금액 20백만원 이상인 경우 0.20%
...
2. 가입금액은 1인당 최소 100만원 이상 5억원 이하이다.', 1250, 360, 52, 0.88),
                                                                                                                                                                                                                                           ('D21', 'The든든예금(시즌2)', 2.90, 3.90, '스마트폰', '2025-12-31', 1000000000, '개인', 1, '①마케팅동의 및 모바일메세지 수신동의 0.05%
...
2. 가입좌수 제한없으며, 가입금액은 1인당 최소 100만원 이상 10억원 이하이다.', 1750, 490, 78, 0.93),
                                                                                                                                                                                                                                           ('D22', 'The파트너예금', 2.75, 3.75, '스마트폰', '9999-12-31', 1000000000, '개인', 1, '①경남은행 거래기간 5년이상 + 마케팅동의 고객 0.20%
...
2. 가입좌수 제한없으며, 가입금액은 1인당 최소 100만원 이상 10억원 이하이다.', 1450, 420, 63, 0.90),
                                                                                                                                                                                                                                           ('D23', 'IBK평생한가족통장(실세금리정기예금)', 2.50, 3.50, '영업점,인터넷,스마트폰', NULL, 100000000, '실명의 개인
...
-주거래우대 : 연 0.15%p', 12, '1백만원 이상', '중소기업은행', 85, 3, 'https://ibk.co.kr', '계좌 수 제한 없으며, 최소 1백만원 이상 통합한도 1억원 이내 가입 가능', 1200, 350, 50, 0.85),
                                                                                                                                                                                                                                           ('D24', 'IBK더굴리기통장(실세금리정기예금)', 2.40, 3.40, '인터넷,스마트폰', NULL, NULL, '실명의 개인
(개인사업자 제외)', 1, '없음', 12, '1백만원 이상', '중소기업은행', 82, 2, 'https://ibk.co.kr', '계좌 수 제한 없으며, 최소 1백만원 이상 납입한도 제한 없음', 1000, 300, 45, 0.82),
                                                                                                                                                                                                                                           ('D25', 'IBK굴리기통장(정기예금)', 2.30, 3.30, '영업점,스마트폰', NULL, 300000000, '실명의 개인
(개인사업자 제외)', 1, '없음', 12, '1백만원 이상', '중소기업은행', 80, 3, 'https://ibk.co.kr', '계좌 수 제한 없으며, 최소 1백만원 이상 통합한도 3억원 이내 가입 가능', 950, 280, 40, 0.80),
                                                                                                                                                                                                                                           ('D26', 'KDB 정기예금', 2.60, 3.60, '영업점,인터넷,스마트폰', NULL, NULL, '제한없음', 1, '해당없음', 12, '해당없음', '한국산업은행', 87, 2, 'https://kdb.co.kr', '해당없음', 1300, 380, 55, 0.87),
                                                                                                                                                                                                                                           ('D27', 'KB Star 정기예금', 2.70, 3.70, '인터넷,스마트폰', NULL, NULL, '실명의 개인 또는 개인사업자', 1, '해당무', 12, '1백만원 이상', '국민은행', 89, 2, 'https://kbstar.com', '- 가입금액 : 1백만원 이상', 1400, 400, 60, 0.89),
                                                                                                                                                                                                                                           ('D28', '쏠편한 정기예금', 2.55, 3.55, '인터넷,스마트폰', NULL, NULL, '만14세이상 개인고객', 1, '해당사항없음', 12, '1만원 이상', '신한은행', 86, 3, 'https://shinhan.com', '1. 가입한도 :
 1만원 이상', 1100, 320, 48, 0.86),
                                                                                                                                                                                                                                           ('D29', 'NH왈츠회전예금 II', 2.80, 3.80, '영업점,인터넷,스마트폰', NULL, NULL, '개인', 1, '1. 급여이체실적(50만원 이상)이 있는 경우 : 0.1%p
...
※ 전월취급평균금리는 본 홈페이지에 공시되지 않는 회전기간 6개월 미만의 계좌들도 포함하여 산출하기 때문에 회전기간별로 공시된 기본금리보다 낮게 보여질 수 있음', 1600, 450, 70, 0.91),
                                                                                                                                                                                                                                           ('D30', 'NH내가Green초록세상예금', 2.90, 3.90, '영업점,인터넷,스마트폰', NULL, NULL, '개인', 1, '※ 우대금리 최대한도 : 0.4%p(연%, 세전)
1. 온실가스 줄이기 실천서약서 동의 : 0.1%p
2. 통장미발급 : 0.3%p
3. 손하나로인증 서비스 등록 : 0.2%p
4. 대중교통이용 : 0.2%p
5. NH내가Green초록세상예금 동시 보유 : 0.1%p', 12, '300만원이상', '농협은행주식회사', 94, 1, 'https://nonghyup.com', '1. 300만원이상 가입
